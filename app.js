...
function createPokeCard(pokemon){
    ...
    // Setting the innerHTML for a new card using the data/object that is passed into the "pokemon" parameter. Also, using the .toUpperCase method on the pokemon name so it will display in UPPERCASE text.
    pokeCard.innerHTML = `
...
// The getPokemonData function makes an Axios Get request to the PokeAPI using a specific pokemon ID/Number; then it takes the returned data and passes it into the createPokeCard function!
